    ...
    constructor(props) {
        ...
        this.state = {
            slidecard: [
                {
                    id: 1,
                    srcimg: 'assets/img/imagebox/service-1.jpg',
                    heading: 'DESIGN & BUILD'
                },
                {
                    id: 2,
                    srcimg: 'assets/img/imagebox/service-2.jpg',
                    heading: 'BUILDING ENVELOPES'
                },
                {
                    id: 3,
                    srcimg: 'assets/img/imagebox/service-3.jpg',
                    heading: 'CONSTRUCTION'
                },
                {
                    id: 4,
                    srcimg: 'assets/img/imagebox/service-4.jpg',
                    heading: 'DESIGN & BUILD'
                },
                {
                    id: 5,
